...
function Home(){
 ...
 //if you stop speaking for a long time it stops listening so let us write the following 3 lines for that.
...
useEffect(()=>{
 ...
 recognition.interimResults = false;
  //for optimizing along with the above mentioned 3 lines
  ...
  //the below code will be running when the recog is started through the methd recognition.start()
  recognition.onstart=()=>{
